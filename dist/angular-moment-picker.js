/*! Angular Moment Picker - v0.10.2 - https://github.com/GlauberF/angular-moment-picker - (c) 2015 Indri Muska - MIT */
            ...
            $transclude(function ($transElement) {
                ...
                $scope.view = {
                    ...
                    close: function () {
                        ...
                        // correção de bug, pois quando usa ng-if, não existe parentNode para acessar
                        // somente funcionava para ng-show
                        if ($scope.picker[0].parentNode) {
